    ...
    ?>
      ...
      <li class="<?php echo $addclass; ?>">
          <h4><a href="<?php the_permalink(); ?>"><?php $title = the_title('','',FALSE); echo substr($title, 0, 40); ?></a></h4>
				<?php if($lightbox!=""){ ?>
        <a class="image-wrap" href="<?php echo $lightbox;?>" rel="prettyPhoto[gallery]" title="<?php the_title();?>"><b class="gallery-img"><?php the_post_thumbnail( 'portfolio-post-thumbnail' ); ?></b><span class="zoom-icon"></span></a>
      <?php }else{ ?>
